...
public class DeveloperMode extends AnAction implements DumbAware {
    ...
    {
        new TerminalExecution(e.getProject()).execute(new Definition("developer_mode", e.getProject()), true);
    }
}
