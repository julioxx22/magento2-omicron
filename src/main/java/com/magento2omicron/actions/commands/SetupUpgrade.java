...
public class SetupUpgrade extends AnAction implements DumbAware {
    ...
    {
        new TerminalExecution(e.getProject()).execute(new Definition("setup_upgrade", e.getProject()), true);
    }
}
