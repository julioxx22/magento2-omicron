package com.magento2omicron.packages.models.StaticsRecompilation;
...
import com.magento2omicron.packages.compilers.Compiler;
...
public class FileRecompiler {
    ...
    public void recompile(List<VirtualFile> files)
    {
        ...
        Notifications.notifyInformation(project,"Magento 2 Omicron | Recompiled successfully.");
    }
