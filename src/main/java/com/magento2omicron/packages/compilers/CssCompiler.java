package com.magento2omicron.packages.compilers;
...
public class CssCompiler extends BaseStaticCompiler {
     ...
     * com.magento2omicron.packages.models.StaticsRecompilation.FileRecompiler#getDefinedFiles(com.intellij.openapi.vfs.VirtualFile).
